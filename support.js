...
(() => {
  ...
  // src/index.ts
  // React is self-hosted (see /vendor) so the site doesn't go blank if unpkg.com
  // is unreachable; files are byte-identical to react@18.3.1 UMD and the SRI
  // hashes below still verify them.
